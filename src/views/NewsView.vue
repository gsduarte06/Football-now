...
.div-2 {
  ...
  background-color: var(--1-blue-boxes, #010d34);
  display: flex;
  width: 700px;
  left: 525px;
  flex-direction: column;
...
.span {
  ...
  background-color: var(--Border-orange, #ff8730);
